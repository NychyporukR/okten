...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    ...
    div.append(text);
    text.innerText = coursesAndDurationArray[i].title + ', ' + coursesAndDurationArray[i].monthDuration;
...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    let div2 = document.createElement('div');
        ...
        paragraph.textContent = coursesAndDurationArray[i].monthDuration;
...
for (let i = 0; i < simpsons.length; i++) {
    ...
    div3.classList.add('member');
        ...
        info.textContent = `Info : ${simpsons[i].info}`;
        photo.src = simpsons[i].photo;
        photo.alt = simpsons[i];
...
for (let i = 0; i < coursesArray.length; i++) {
   ...
   let monthDuration = document.createElement('p');
    ...
    monthDuration.style.marginRight = '250px';
    ...
    div4.appendChild(monthDuration);
    div4.appendChild(hourDuration);
    div4.appendChild(modulesList);
